    ...
    if oportjson.endswith('.json'):
        ...
        with open(json_file_path, 'r') as f:
            ...
            for deal in data['deals']:
                ...
                for custom_field in deal_custom_fields:
                    custom = custom_field['custom_field']
                    if isinstance(custom, dict):
                        custom_field_id = custom.get('id', 0)
                        custom_field_label = custom.get('label', 0)
                        custom_field_type = custom.get('type', 0)
                    else:
                        custom_field_id = 0
                        custom_field_label = 0
                        custom_field_type = 0

                cur.execute("""INSERT INTO TESTESOPORTUNIDADE2 (
                insert_time,
                deal_id,
                deal_name,
                deal_amount_montly,
                ...
                NOW(), %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s
                );""",
                            (
                                deal_id,
                                deal_name,
